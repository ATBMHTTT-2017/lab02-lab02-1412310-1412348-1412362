...
( p_MaNV in nchar := 10, p_HoTen in nvarchar2 := 100,p_DiaChi in nvarchar2 := 100,p_DienThoai in char := 15,p_Email in nvarchar2 := 50, p_MaPhong  in nchar := 10,chiNhanh in nchar:=10,p_LuongNV in int)
IS
 l_key raw(255);
begin
